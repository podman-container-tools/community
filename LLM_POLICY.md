...
- Explicitly test modified functionality
...
- Understand required implementations
...
Using LLMs as tools is acceptable; using them as replacements for understanding and responsibility is not.
